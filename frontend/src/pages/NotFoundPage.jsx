...
const NotFoundPage = () => {
  return <>
    ...
    <main className=" bg-clip-content p-10 flex flex-row items-center justify-start bg-bg404 bg-no-repeat bg-cover bg-fixed bg-center min-h-screen">
      <div className="-ml-5 bg-bgDark flex flex-col items-center py-10 pr-5 rounded-xl text-white">
        <p className="text-6xl font-semibold text-red-500">404</p>
        <h1 className="mt-4 text-3xl font-bold tracking-tight  sm:text-5xl text-red-500">Page not found</h1>
